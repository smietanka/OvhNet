...
namespace OvhWrapper
{
    public class OvhWrapper
    {
        ...
        private OvhWrapper() { }
        public OvhWrapper(Uri endPoint, string applicationKey, string applicationSecret, string consumerKey)
        {
        ...
        public OvhWrapper(string endPoint, string applicationKey, string applicationSecret, string consumerKey)
        {
            ApplicationKey = applicationKey;
            ApplicationSecret = applicationSecret;
            ConsumerKey = consumerKey;
        ...
        public OvhWrapper(Uri endPoint, string applicationKey, string applicationSecret, string consumerKey, string serviceName)
        {
            ApplicationKey = applicationKey;
            ApplicationSecret = applicationSecret;
            ConsumerKey = consumerKey;
        ...
        public OvhWrapper(string endPoint, string applicationKey, string applicationSecret, string consumerKey, string serviceName)
        {
            ApplicationKey = applicationKey;
            ApplicationSecret = applicationSecret;
            ConsumerKey = consumerKey;
